...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks,config, w=1, num_classes=10):
        ...
        print("The number of classes in the dataset : ", self.num_classes)
...
def resnet20(config):
    return ResNet(BasicBlock, [3, 3, 3], config, w=1).to(config["device"])